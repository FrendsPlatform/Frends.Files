...
{
    /// <summary>
    /// Gets or sets a value indicating whether remote connection is used.
    ...
    /// <summary>
    /// Gets or sets username. This needs to be of format domain\username.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets password for the used credentials.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets encoding for the written content. By selecting 'Other' you can use any encoding.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether enablation BOM for UTF-8.
    /// </summary>
    /// <example>true</example>
    ...
    /// <summary>
    /// Gets or sets file encoding to be used. A partial list of possible encodings: https://en.wikipedia.org/wiki/Windows_code_page#List.
    /// </summary>
