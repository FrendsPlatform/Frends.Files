...
{
    /// <summary>
    /// Moves files from a source directory to a target directory based on a file pattern.
    ...
    /// <returns>Result object { bool Success, object Error { string Message, Exception AdditionalInfo }, List&lt;FileItem&gt; Files}</returns>
