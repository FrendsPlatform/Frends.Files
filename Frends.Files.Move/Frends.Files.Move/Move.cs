...
namespace Frends.Files.Move
{
    ...
    public class Files
    {
        ...
        public static Result Move([PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
        {
            var files = ExecuteAction(() => ExecuteMove(input, cancellationToken), options.UseGivenUserCredentialsForRemoteConnections, options.UserName, options.Password);
        ...
        private static List<FileItem> ExecuteMove(Input input, CancellationToken cancellationToken)
        {
